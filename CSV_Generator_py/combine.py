...
# Split each line and create a list of lists for Nutrient Index
data2 = [line.strip().split('^')[:5] for line in lines2]

# Create DataFrame for Nutrient Index
...
print("Combined CSV file has been saved as combined_output.csv")
